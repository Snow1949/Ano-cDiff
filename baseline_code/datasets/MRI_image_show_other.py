...
tumor1 = "/chenxue/Diff-SCM-main/diff_scm/datasets/data/brats2021_64x64/npy_train/patient_BraTS2021_01562" \
        "/slice_25.npz"
tumor2 = "/chenxue/Diff-SCM-main/diff_scm/datasets/data/brats2021_64x64/npy_train/patient_BraTS2021_01562" \
        "/slice_97.npz"
tumor3 = "/chenxue/Diff-SCM-main/diff_scm/datasets/data/brats2021_64x64/npy_train/patient_BraTS2021_01562" \
        "/slice_126.npz"
healthy1 = "/chenxue/Diff-SCM-main/diff_scm/datasets/data/brats2021_64x64/npy_train/patient_BraTS2021_01562" \
        "/slice_24.npz"
healthy2 = "/chenxue/Diff-SCM-main/diff_scm/datasets/data/brats2021_64x64/npy_train/patient_BraTS2021_01562" \
        "/slice_13.npz"
healthy3 = "/chenxue/Diff-SCM-main/diff_scm/datasets/data/brats2021_64x64/npy_train/patient_BraTS2021_01562" \
        "/slice_134.npz"
...
plt.subplot(6, 5, 1)
plt.imshow(tumor1_img0, cmap='inferno')
plt.subplot(6, 5, 2)
plt.imshow(tumor1_img1, cmap='inferno')
plt.subplot(6, 5, 3)
plt.imshow(tumor1_img2, cmap='inferno')
plt.subplot(6, 5, 4)
plt.imshow(tumor1_img3, cmap='inferno')
plt.subplot(6, 5, 5)
plt.imshow(tumor1_img4, cmap='inferno')
plt.subplot(6, 5, 6)
plt.imshow(tumor2_img0, cmap='inferno')
plt.subplot(6, 5, 7)
plt.imshow(tumor2_img1, cmap='inferno')
plt.subplot(6, 5, 8)
plt.imshow(tumor2_img2, cmap='inferno')
plt.subplot(6, 5, 9)
plt.imshow(tumor2_img3, cmap='inferno')
plt.subplot(6, 5, 10)
plt.imshow(tumor2_img4, cmap='inferno')
plt.subplot(6, 5, 11)
plt.imshow(tumor3_img0, cmap='inferno')
plt.subplot(6, 5, 12)
plt.imshow(tumor3_img1, cmap='inferno')
plt.subplot(6, 5, 13)
plt.imshow(tumor3_img2, cmap='inferno')
plt.subplot(6, 5, 14)
plt.imshow(tumor3_img3, cmap='inferno')
plt.subplot(6, 5, 15)
plt.imshow(tumor3_img4, cmap='inferno')

plt.subplot(6, 5, 16)
plt.imshow(healthy1_img0, cmap='inferno')
plt.subplot(6, 5, 17)
plt.imshow(healthy1_img1, cmap='inferno')
plt.subplot(6, 5, 18)
plt.imshow(healthy1_img2, cmap='inferno')
plt.subplot(6, 5, 19)
plt.imshow(healthy1_img3, cmap='inferno')
plt.subplot(6, 5, 20)
plt.imshow(healthy1_img4, cmap='inferno')
plt.subplot(6, 5, 21)
plt.imshow(healthy2_img0, cmap='inferno')
plt.subplot(6, 5, 22)
plt.imshow(healthy2_img1, cmap='inferno')
plt.subplot(6, 5, 23)
plt.imshow(healthy2_img2, cmap='inferno')
plt.subplot(6, 5, 24)
plt.imshow(healthy2_img3, cmap='inferno')
plt.subplot(6, 5, 25)
plt.imshow(healthy2_img4, cmap='inferno')
plt.subplot(6, 5, 26)
plt.imshow(healthy3_img0, cmap='inferno')
plt.subplot(6, 5, 27)
plt.imshow(healthy3_img1, cmap='inferno')
plt.subplot(6, 5, 28)
plt.imshow(healthy3_img2, cmap='inferno')
plt.subplot(6, 5, 29)
plt.imshow(healthy3_img3, cmap='inferno')
plt.subplot(6, 5, 30)
plt.imshow(healthy3_img4, cmap='inferno')

plt.title('skip all healthy slices in tumor patients')
# plt.imshow(healthy1_img0, cmap='inferno')
path = '/chenxue/Diff-SCM-main/diff_scm/pictures/'
plt.savefig(path + 'skip_healthy_in_tumor.jpg')
plt.show()
