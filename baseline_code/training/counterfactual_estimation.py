...
from baseline_code.utils.script_util import create_anti_causal_predictor, create_gaussian_diffusion
...
from baseline_code.training.train_util import parse_resume_step_from_filename, log_loss_dict
...
def main(args):
    ...
    print('Needed for creating correct EMAs and fp16 parameters')
    ...
    def forward_backward_log(data_loader, prefix="train"):
        ...
        if args.dataset == "brats":
            batch = torchvision.transforms.Resize(size=64)(batch)
            # batch = torchvision.transforms.Resize(size=128)(batch)
