...
def get_default_configs():
    ...
    experiment_path = r"/chenxue/experiment_data/"
    ...
    # init
    #sampling.model_path = experiment_path + config.experiment_name + f"/score_train/model5270000.pt"
    # 2023-07-15-17 47
    sampling.model_path = experiment_path + config.experiment_name + f"/score_train/model080000.pt"
    
    # /chenxue/experiment_data/anomaly_diffusion_healthy_only_train_brats2021_64x64/score_train
    # /chenxue/Diff-SCM-main/diff_scm/datasets/RDS/experiment_data/anomaly_diffusion_healthy_only_train_brats2021_64x64/score_train_icondFalse_ccondFalse/model050000.pt
