		...
		for step, i in enumerate(indices):  # 遍历，将indices送入ddim_sample中，0<=step<=74
			...
			with th.no_grad():
				if reverse:         # reverse == encoding
					...
					ecoding_img_path = os.path.join(logger.get_dir(), f"/chenxue/experiment_data/loop_progressive_0831/ecoding_weight_{str(step).zfill(4)}_{str(currt_len).zfill(4)}.png")
					...
					for ith in range(32):
						...
						ecoding_sample_images.save('/chenxue/experiment_data/loop_progressive_0831/ecoding_sampling_' + str(step).zfill(4) + '_' + str(ith).zfill(4) + '.jpg')
					...
					for ith in range(32):
						...
						ecoding_pred_xstart_images.save('/chenxue/experiment_data/loop_progressive_0831/ecoding_predxstart_' + str(step).zfill(4) + '_' + str(ith).zfill(4) + '.jpg')
